...
@implementation TZWebPhotoPreviewCell

- (void)configSubviews {
    self.previewView = [[TZWebPhotoPreviewView alloc] initWithFrame:CGRectZero];
...
@implementation TZWebPhotoPreviewView
...
- (void)setAllowCrop:(BOOL)allowCrop {
    ...
    CGFloat aspectRatio = _photo.size.width / _photo.size.height;
    if (aspectRatio > 1.5) {
